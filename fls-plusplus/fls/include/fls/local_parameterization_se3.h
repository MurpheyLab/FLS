//
// Created by msun on 1/8/22.
//

#ifndef FLS_LOCAL_PARAMETERIZATION_SE3_H
#define FLS_LOCAL_PARAMETERIZATION_SE3_H
...
namespace Sophus
{
    ...
    public:
        ...
        /*
         * Jacobian of SE(3) plus operation for ceres
         * Dx T * exp(x) with x=0
         */
...
#endif //FLS_LOCAL_PARAMETERIZATION_SE3_H
